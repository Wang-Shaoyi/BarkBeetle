...
{
    internal class SkeletonPackage
    {
        // 1 strip width
        ...
        // Constructor
        public SkeletonPackage(double stripWidth, Surface extendedSurface, GH_Structure<GH_Point> organizedPtsTree, string skeletonOption)
        {
