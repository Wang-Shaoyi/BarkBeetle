...
namespace BarkBeetle.CompsModelRefine
{
    public class UnpackGeometryPackage : GH_Component
    {
        ...
        /// </summary>
        public UnpackGeometryPackage()
          : base("Unpack Geometry Package", "Unpack Geo",
              "Unpack all geometries in the Geometry Package",
        ...
        {
            pManager.AddGenericParameter("Geometry package", "Geo", "BarkBeetle GeometryPackage Object", GH_ParamAccess.item);
        }
        ...
        protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
        {
            ...
            pManager.AddPointParameter("Skeleton points", "Skeleton", "Skeleton points", GH_ParamAccess.list);
            pManager.AddCurveParameter("UV curves", "C", "uv iso curves", GH_ParamAccess.tree);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            GeometryPackage geoPack = goo.Value;
            ...
            GH_Structure<GH_Vector> uvVectors = TreeHelper.Convert3DArrayToGHStructure(geoPack.UVVectors);

            // Output
            DA.SetDataTree(0, organizedPtTree);
            DA.SetData(1, extendedSrf);
            DA.SetDataList(2, skeletonPts);
            DA.SetDataTree(3, uvCurves);
            DA.SetDataTree(4, uvVectors);
        }
