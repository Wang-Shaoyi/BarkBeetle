...
namespace BarkBeetle.ToolpathBaseSetting
{
    internal class ToolpathBaseSpiral : ToolpathBase
    {
        ...
        private Point3d[,,] ReplicatePtsToCorners()
        {
            ...
            List<GH_Point> gH_Points = SkeletonPackage.Skeleton.SkeletonPoints;
            List<(int, int, int)> skeletonStructure = SkeletonPackage.Skeleton.SkeletonStructure;
            GH_Vector[,,] uvVectors = SkeletonPackage.Skeleton.UVVectors;

            // calculate number of circles
            double stripWidth = SkeletonPackage.StripWidth;
        ...
        private Point3d[,,] SpiralToolpathPtsProcess(Point3d[,,] ptArray3D)
        {
            ...
            GH_Point[,] organizedPtsArray = SkeletonPackage.Skeleton.OrganizedPtsArray;
            GH_Vector[,,] uvVectors = SkeletonPackage.Skeleton.UVVectors; //[u,v,main/sub]
            List<(int, int, int)> skeletonStructure = SkeletonPackage.Skeleton.SkeletonStructure;
