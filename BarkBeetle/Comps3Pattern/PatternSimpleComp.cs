...
{
    public class PatternSimpleComp : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the Toolpath class.
        /// </summary>
        public PatternSimpleComp()
          : base("Simple Pattern", "Simple Pattern",
              "A simple outline generated from the skeleton as a layer of the toolpath",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // Run Function
            ToolpathPattern pattern = new ToolpathPatternSimple(skeletonGraph, ghpt.Value,pathWidth);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Resources.SimplePattern;
            }
        }
        ...
        {
            get { return new Guid("6897049D-2A84-4F1A-B30D-17DFF85705CD"); }
        }
    }
}