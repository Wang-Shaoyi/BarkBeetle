...
{
    public class SpiralSkeletonGraphComp : GH_Component
    {
        /// <summary>
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // Run Function
            SkeletonGraphSpiral spiral = new SkeletonGraphSpiral(network);
            ...
            List<GH_Curve> curves = spiral.SkeletonBranchCurves;
        ...
        {
            get { return new Guid("BC74A5BA-F82B-49F8-8860-4E0A30D8F4B2"); }
        }
    }
}